    ...
    <div className="pt-32 pb-24 bg-gradient-to-b from-slate-50 via-white to-slate-100 relative min-h-screen">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-5xl md:text-6xl font-bold mb-4 bg-gradient-to-r from-royal-800 via-royal-600 to-royal-500 bg-clip-text text-transparent">Home Loan</h1>
          ...
          <p className="text-xl text-slate-800 max-w-4xl mx-auto leading-relaxed">
            Buying your dream home? We help you get the most competitive interest rates with flexible repayment options.
          </p>
        </div>
          ...
          <div className="bg-gradient-to-br from-white to-slate-50 p-8 rounded-2xl border border-slate-200">
            ...
            <ul className="space-y-4">
              <li className="text-slate-800 flex items-start">
                ...
                <span>Loan up to 90% of property value</span>
              </li>
              <li className="text-slate-800 flex items-start">
                <span className="text-slate-600 mr-3 text-xl">✓</span>
              ...
              <li className="text-slate-800 flex items-start">
                <span className="text-slate-600 mr-3 text-xl">✓</span>
                <span>Top-up loan available</span>
              </li>
              <li className="text-slate-800 flex items-start">
                <span className="text-slate-600 mr-3 text-xl">✓</span>
              ...
              <li className="text-slate-800 flex items-start">
                <span className="text-slate-600 mr-3 text-xl">✓</span>
                <span>Quick processing & doorstep service</span>
              </li>
            </ul>
          </div>
        ...
        <div className="bg-gradient-to-br from-purple-400/10 to-pink-400/10 p-12 rounded-3xl border-2 border-slate-200 text-center">
          <h3 className="text-3xl font-bold text-slate-700 mb-4">Ready to Own Your Dream Home?</h3>
          <p className="text-slate-800 mb-8 text-lg">Get the best home loan rates from 100+ trusted lenders</p>
