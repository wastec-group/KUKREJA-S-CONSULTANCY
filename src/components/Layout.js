        ...
        <nav className="container mx-auto px-6 py-5">
          <div className="flex justify-between items-center">
            <Link to="/" className="flex items-center space-x-3">
              <img src="/logo.png" alt="Kukreja's Consultancy Logo" className="h-12 w-auto rounded-md" />
      ...
      <footer className="bg-gradient-to-r from-royal-900 via-royal-800 to-royal-900 text-white py-12 border-t border-royal-700">
        <div className="container mx-auto px-6 text-center">
          <div className="flex items-center justify-center space-x-3 mb-3">
            <img src="/logo.png" alt="Kukreja's Consultancy Logo" className="h-10 w-auto rounded-md" />
            <p className="text-2xl font-bold bg-gradient-to-r from-royal-400 via-royal-300 to-royal-400 bg-clip-text text-transparent">KUKREJA'S CONSULTANCY</p>
          </div>
